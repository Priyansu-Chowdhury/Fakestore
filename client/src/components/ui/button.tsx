  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        expandIconOutline:
          "group relative text-primary bg-transparent hover:bg-transparent border border-slate-500",
        expandIcon:
    ...
    return (
      ...
      >
        {Icon && iconPlacement === "left" && (
          <div className="w-0 -translate-x-[50%] pr-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-100 group-hover:pr-2 group-hover:opacity-100">
            <Icon />
          </div>
        )}
